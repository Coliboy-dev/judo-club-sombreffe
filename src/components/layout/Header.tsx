  ...
  return (
    <>
          ...
          <div className="flex items-center justify-between h-16 lg:h-20">
            ...
            >
              ...
              <div className="hidden sm:block">
                ...
                <span className="block text-neutral-100 text-xs tracking-widest uppercase opacity-75">
                  Province de Namur
                </span>
              </div>
            </Link>
            ...
            <Link
              href="/contact"
              className="hidden lg:inline-flex items-center px-5 py-2 bg-accent text-white text-sm font-semibold uppercase tracking-wide hover:bg-accent-light transition-colors duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 focus-visible:ring-offset-primary"
            >
              Cours d&apos;essai
            </Link>
      ...
      >
        ...
        <div
          className={cn(
            "absolute top-16 left-0 right-0 bg-primary shadow-xl transition-transform duration-200",
        ...
        >
          ...
          <div className="px-6 py-4 border-t border-primary-light">
            <Link
              href="/contact"
              onClick={() => setMenuOpen(false)}
              className="block w-full text-center px-6 py-3 bg-accent text-white font-semibold uppercase tracking-wide hover:bg-accent-light transition-colors"
            >
